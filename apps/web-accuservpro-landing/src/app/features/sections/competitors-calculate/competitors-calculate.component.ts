...
@Component({
  ...
  selector: 'section-competitors-calculate',
  templateUrl: 'competitors-calculate.component.html',
...
export class competitorsCalculateComponent extends BaseComponent {
  @Input() data:any
  constructor() {
    super();
  }
